                            ...
                            <table id="table_register_detail" class="table table-bordered" >
                                <thead>
                                    <tr class="active">
                                        ...
                                        <th style="width:25%">Manifest</th>
                                        <th style="width:25%">Tgl Manifest</th>
                                        <th style="width:25%">Resi</th>
                                        <th style="width:20%">Produk</th>
                                        <th style="width:5%">Qty Awal</th>
                                        <th style="width:5%">Qty Terima</th>
                                        <th style="width:5%">Qty Saldo</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                ...
                                <input type="button" id="pilih_manifest" name="submit" value='PILIH SEMUA' class='btn btn-warning'>
                        </div>
                        <div>
                            <div id="manifest_area" style="padding: 20px 20px 20px 0px; margin: 10px 10px 10px 0px;">
                                ...
                                <table id="table_manifest_detail" class="table table-bordered">
                                    ...
                                    <tbody>
                                            ...
                                            <td class="editMe"><?php echo $cc->nomor_manifest; ?></td>
                        ...
                        <div class="table-wrapper-scroll-y my-custom-scrollbar" id="details" >
                            <table id="data_details" class="table table-striped" >
                                ...
                                <tbody>
                                        ...
                                        <td class="" style="cursor:pointer"><?php echo $reg->nomor_manifest; ?></td>
                                        <td class="" style="cursor:pointer"><?php echo $reg->nomor; ?></td>
                                        <td class="" style="cursor:pointer"><?php echo $reg->nama; ?></td>
                                        <td class="" style="cursor:pointer"><?php echo $reg->tanggal_berangkat; ?></td>
                                        </tr>
                                        <?php
                                                $_i = $_i + 1;
                                                }
