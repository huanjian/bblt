<?php namespace App\Http\Controllers;
	...
	class AdminPelangganController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Lokasi','name'=>'lokasi','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-2','dataenum'=>'mataram;bali;surabaya'];
			...
			//$this->form[] = ['label'=>'Lokasi','name'=>'lokasi','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'mataram;bali;surabaya'];
			# OLD END FORM
