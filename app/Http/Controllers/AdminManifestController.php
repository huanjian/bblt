<?php namespace App\Http\Controllers;
	...
	class AdminManifestController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Tujuan","name"=>"cabang_id","join"=>"cabang,nama"];
			$this->col[] = ["label"=>"Nomor Resi","name"=>"register_id","join"=>"register,resi"];
			$this->col[] = ["label"=>"Alamat Tujuan","name"=>"alamat_tujuan"];
			$this->col[] = ["label"=>"Keterangan","name"=>"keterangan"];
			$this->col[] = ["label"=>"Quantity Awal","name"=>"quantity_awal"];
			...
			$this->form[] = ['label'=>'Kendaraan','name'=>'kendaraan_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-2','datatable'=>'kendaraan,nomor'];
			$this->form[] = ['label'=>'Pengemudi','name'=>'pengemudi_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-2','datatable'=>'pengemudi,nama'];
			$this->form[] = ['label'=>'Tanggal Berangkat','name'=>'tanggal_berangkat','type'=>'date','validation'=>'required|date','width'=>'col-sm-2'];
			...
			$this->form[] = ['label'=>'Register','name'=>'register_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-3','datatable'=>'register,resi'];
			...
			$this->form[] = ['label'=>'Quantity Awal','name'=>'quantity_awal','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-2'];
			$this->form[] = ['label'=>'Sequence','name'=>'sequence','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-2'];
